...
function Footer() {
  ...
  return (
    <footer className="border-t border-border p-2 mt-10">
      <p className="text-center font-medium">{t("footer.contact")}</p>
      <div className="flex justify-center items-center mt-4 gap-4">
        <a aria-label="Email" href="mailto:abdultawab940@gmail.com">
          <svg
            fill="currentColor"
            version="1.1"
            id="Layer_1"
        ...
        <a aria-label="Telegram" href="https://t.me/Mohammedmansour200">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            width="30"
